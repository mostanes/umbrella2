...
namespace Umbrella2
{
	...
	public static class StandardDetectionFactory
	{
		...
		/// Internally, fetches the intensities from the image at the given position and calls <see cref="CreateDetection(Image, IEnumerable{PixelPoint}, IEnumerable{double})"/>.
		/// </summary>
		/// <param name="Image">Image on which the object was detected.</param>
		...
		public static ImageDetection CreateDetection(Image Image, IEnumerable<PixelPoint> Points)
		{
