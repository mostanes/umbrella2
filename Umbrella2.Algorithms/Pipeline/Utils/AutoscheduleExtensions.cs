...
#warning Not Implemented; Bug.
		...
		/// <param name="ExtraProperties">List of properties to be passed to the image constructor.</param>
		/// <returns>The desired image.</returns>
		public static Image EnsureImage(Action<Image> Algorithm, Image Model, string RunDir, string Name, int Number, int BitPix = 0, List<ImageProperties> ExtraProperties = null)
		...
		/// <param name="ExtraProperties">List of properties to be passed to the image constructor.</param>
		/// <returns>The desired image.</returns>
		public static Image EnsureImage(Action<Image> Algorithm, Image Input, string RunDir, string Name, int Number, string DisplayName, int BitPix = 0, List<ImageProperties> ExtraProperties = null)
		{
			Image img = EnsureImage(Algorithm, Input, RunDir, Name, Number, BitPix, ExtraProperties);
		...
		/// <param name="ExtraProperties">List of properties to be passed to the image constructor.</param>
		/// <returns>The desired image.</returns>
		public static Image SchedEnsure<T>(SchedCore.SimpleMap<T> Algorithm, SchedCore.AlgorithmRunParameters Parameters, T Argument,
			Image Input, string RunDir, string Name, int Number, int BitPix = 0, List<ImageProperties> ExtraProperties = null)
			=> EnsureImage((Image f) => Algorithm.Run(Argument, Input, f, Parameters), Input, RunDir, Name, Number, BitPix, ExtraProperties);
		...
		/// <param name="ExtraProperties">List of properties to be passed to the image constructor.</param>
		/// <returns>The desired image.</returns>
		public static Image SchedEnsure<T>(SchedCore.PositionDependentMap<T> Algorithm, SchedCore.AlgorithmRunParameters Parameters, T Argument,
			Image Input, string RunDir, string Name, int Number, int BitPix = 0, List<ImageProperties> ExtraProperties = null)
			=> EnsureImage((Image f) => Algorithm.Run(Argument, Input, f, Parameters), Input, RunDir, Name, Number, BitPix, ExtraProperties);
		...
		/// <returns>The desired image.</returns>
		public static Image SchedEnsure<T>(SchedCore.SimpleMap<T> Algorithm, SchedCore.AlgorithmRunParameters Parameters, T Argument,
			Image Input, string RunDir, string Name, int Number, string DisplayName, int BitPix = 0, List<ImageProperties> ExtraProperties = null)
			=> EnsureImage((Image f) => Algorithm.Run(Argument, Input, f, Parameters), Input, RunDir, Name, Number, DisplayName, BitPix, ExtraProperties);
